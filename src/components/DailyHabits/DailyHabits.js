            ...
            return (
                habits.map((habit) => (
                    ...
                    >
                        ...
                        <motion.div onClick={() => deleteHabitWrapper(habit)}  whileHover={{ scale: 1.1 }} className="elete__icon habit__card-delete" style={{ backgroundColor:"#c5221d", width: "20px", borderRadius: "5px", textAlign: "center", padding: "5px 10px 5px 10px"}}>
